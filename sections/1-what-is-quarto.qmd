...
*`r fontawesome::fa("palette", fill = "#5A5A5A", a11y = "sem")` Art by [Allison Horst](https://twitter.com/allison_horst). Be sure to check out the rest of Allison's seriously cute Quarto penguin art in the rstudio::conf(2022) keynote talk, [Hello Quarto](https://mine.quarto.pub/hello-quarto/#/hello-quarto-title), by [Julie Lowndes](https://openscapes.org/team) & [Mine Çetinkaya-Rundel](https://mine-cr.com/)!*
:::
