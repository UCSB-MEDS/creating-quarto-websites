...
Both Positron and RStudio will make updating your website a productive and fun experience. You choose!
:::
...
5. add button links to your favorite social media pages (e.g. LinkedIn, GitHub, and even your email (note the `mailto:` that must precede your email address, `mailto:youremail.com`; when this button is clicked, it opens a new, blank email in your default email client))
6. adding this option tells the browser to open the link in a new tab
