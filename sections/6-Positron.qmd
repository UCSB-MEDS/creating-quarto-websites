...
knitr::include_graphics("media/positron-kill-preview.png")
```
...
::: {.panel-tabset}
## **{{< fa brands git-alt title="Git icon" >}} Use Git (recommended)**

*This option allows us to keep our Quarto Project as-is (no need to convert to an R Project)*

i. Ensure that you're in your project's root directory (e.g. `mysite/`) by typing `pwd` (print working directory) in the Terminal
...
## **{{< fa brands git-alt title="Git icon" >}} Use Git**
