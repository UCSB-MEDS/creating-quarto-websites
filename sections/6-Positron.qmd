...
iii. Quit your preview by pressing `Ctrl` + `C` in your Terminal or by clicking on the **Quarto Preview**the trash can icon next to your **Quarto Preview** button (in your Terminal), then click **Kill Terminal**:
