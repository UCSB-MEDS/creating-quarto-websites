...
3. use a [pre-built template](https://quarto.org/docs/websites/website-about.html#templates) (here, `jolla`) to update the layout of your landing page (or any page!)
...
Quarto's built-in [templates](https://quarto.org/docs/websites/website-about.html#templates) are great for a couple reasons, primarily:
...
I briefly touch on using [Bootstrap CSS Grid](https://quarto.org/docs/output-formats/page-layout.html#css-grid) to build these responsive custom web page layouts in this [blog post](https://samanthacsik.github.io/posts/2023-08-01-openscapes-website/#greatest-victory-responsive-web-pages). Check out the [Quarto documentation](https://quarto.org/docs/output-formats/page-layout.html) to learn more. 
:::
