...
### {{< fa arrow-right title="An arrow pointing to the right" >}} **Arrange your landing page (`index.qmd`) using a [pre-build template](https://quarto.org/docs/websites/website-about.html){target="_blank"}**
