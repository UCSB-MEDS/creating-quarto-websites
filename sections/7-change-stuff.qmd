...
format:
  html:
    ...
    page-layout: full # <3>
```
1. Your website title, which appears in your browser tab and in the top left corner of your website's navbar (by default)
...
Going for a more minimalist look? You can comment out (or remove) the `title` option from `index.qmd`. You'll note that this also cleans up the title which appears in your browser tab.
```{r}
#| echo: false
#| fig-align: center
#| fig-cap: ""
