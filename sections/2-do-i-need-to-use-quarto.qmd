...
Alternatively, you can skip R altogether and build really beautiful sites using HTML templates (check out [this tutorial](https://rpubs.com/alatleephillips/science-website-tutorial) by past NCEAS Science Communication and Policy Officer / current Bren Teaching Faculty, [Alex Phillips](https://www.alexandraatleephillips.com/)) or a variety of [static site generators](https://jamstack.org/generators/?utm_source=blog&utm_medium=about-ssgs-pnh&utm_campaign=devex) (e.g. [Hugo](https://gohugo.io/), [Jekyll](https://jekyllrb.com/)).
