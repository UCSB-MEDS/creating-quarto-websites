...
3.  Fill out the **Directory name:** field (this is the name of your R project, and eventually, your GitHub repo name), and choose where to save your directory using the **Browse** button. Click **Create Project**.
