...
- While RStudio remains a powerful and popular IDE for R users, Positron is positioned to become its (likely) successor in the long term

::: {.callout-tip collapse="true"}
## A couple optional Positron customizations
...
iii. Initialize your project as a **git repository** by running the following in your console: 
